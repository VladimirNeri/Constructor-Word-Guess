...
function initializeGame() {
  ...
  console.log("\nThe Ultimate Constructor Word Guess Game!\nGuess the word before you run out of chances.\nThe words are related to Formula 1 Teams")
  
  initializePackage.hasRun = true;
  
  // shuffle the list of words into a new, reordered array
  var wordList = ["mercedes", "ferrari", "williams", "renault", "redbull", "honda", "", "mclaren", "tororosso", "sauber"];
